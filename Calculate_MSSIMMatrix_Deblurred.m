...
deblurred_folder = 'DRBNet/Deblurred Images';
output_folder = 'DRBNet';
...
save(fullfile(output_folder, 'mssim_matrices_DeblurredImages.mat'), 'mssim_matrices');

%%
load(fullfile(output_folder, 'mssim_matrices_DeblurredImages.mat'), 'mssim_matrices');

% Iterate over each image's MSSIM matrix
for img_idx = 1:23
