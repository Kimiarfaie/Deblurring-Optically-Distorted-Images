function [kernel, interim_latent] = blind_deconv(y, lambda_data, lambda_grad, opts)
...
for s = num_scales:-1:1
  ...
  %-----------------------------------------------------------%
  [ks, lambda_data, lambda_grad, interim_latent] = blind_deconv_main(ys, ks, lambda_data,...
