function im_quality = lpc_color(im)
imColor=double(im);
RChannel1 = imColor(:,:,1);
GChannel1 = imColor(:,:,2);
BChannel1 = imColor(:,:,3);
...
[si_intensity, ~] = lpc_si(intensity,[1 2 4], [1 -3 2], 2,1e-4,2,20);
[si_alpha, ~] = lpc_si(alpha,[1 2 4], [1 -3 2], 2,1e-4,4,20);
[si_betta, ~] = lpc_si(betta,[1 2 4], [1 -3 2], 2,1e-4,4,20);
